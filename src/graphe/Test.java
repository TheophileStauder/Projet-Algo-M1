...
public class Test{
    ...
    public static void main(String[] args) {
		...
		Display displayKruskal = new Display();
		Kruskal algoKruskal = new Kruskal(Graph.Grid(4));
		Graph arbreCouvrant = algoKruskal.calcul();
		displayKruskal.setImage(arbreCouvrant.toImage());
